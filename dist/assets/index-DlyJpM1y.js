...
5. Vertical format
6. Clean, flowing composition`}],h=[{key:"mandal",label:"બાળમંડળનું નામ (Mandal Name) *",placeholder:"દા.ત. અક્ષરધામ",maxlength:30,suggestions:["અક્ષરધામ","શાહીબાગ","Robbinsville","Sarangpur"]},{key:"date",label:"તારીખ (Sabha Date) *",placeholder:"દા.ત. ૩૧ મે, ૨૦૨૬",maxlength:30,suggestions:["૩૧ મે, ૨૦૨૬","૭ જૂન, ૨૦૨૬","૧૪ જૂન, ૨૦૨૬"]},{key:"day",label:"વાર (Sabha Day) *",placeholder:"દા.ત. રવિવાર",maxlength:15,suggestions:["રવિવાર","શનિવાર"]},{key:"time",label:"સમય (Sabha Time) *",placeholder:"દા.ત. સાંજે ૪:૩૦ થી ૬:૦૦",maxlength:40,suggestions:["સાંજે ૪:૩૦ થી ૬:૦૦","સવારે ૯:૦૦ થી ૧૦:૩૦"]},{key:"venue",label:"સ્થળ (Sabha Venue) *",placeholder:"દા.ત. બી.એ.પી.એસ. સ્વામિનારાયણ મંદિર",maxlength:80,suggestions:["બી.એ.પી.એસ. સ્વામિનારાયણ મંદિર સભા હોલ","બાળ સભા રૂમ"]},{key:"attr1",label:"આકર્ષણ ૧ (Attraction 1)",placeholder:"દા.ત. ધમાકેદાર ગેમ્સ અને એક્ટિવિટી",maxlength:60,suggestions:["ધમાકેદાર ગેમ્સ અને એક્ટિવિટી","રસપ્રદ રમત ગમત","બાળ વાર્તા"]},{key:"attr2",label:"આકર્ષણ ૨ (Attraction 2)",placeholder:"દા.ત. આનંદદાયક ઓડિયો-વિઝ્યુઅલ શો",maxlength:60,suggestions:["આનંદદાયક ઓડિયો-વિઝ્યુઅલ શો","પ્રેરણાત્મક વિડીયો શો","કિર્તન આરાધના"]},{key:"attr3",label:"આકર્ષણ ૩ (Attraction 3)",placeholder:"દા.ત. રસપ્રદ ક્વિઝ અને ઇનામો",maxlength:60,suggestions:["રસપ્રદ ક્વિઝ અને આકર્ષક ઇનામો","બાળ શિબિર માહિતી","પ્રસાદ વિતરણ"]}],k=["http","https","www",".com",".net",".org","casino","poker","free cash","earn money","crypto","buy now","discount","promo","sex","vulgar","abuse","damn","hell","stupid","hate","kill","die","fight","bad","spam","click here","subscribe","hack","virus","fuck","ass","bitch","bastard"],P=["૦","૧","૨","૩","૪","૫","૬","૭","૮","૯"],A=["જાન્યુઆરી","ફેબ્રુઆરી","માર્ચ","એપ્રિલ","મે","જૂન","જુલાઈ","ઓગસ્ટ","સપ્ટેમ્બર","ઓક્ટોબર","નવેમ્બર","ડિસેમ્બર"];function L(t){return t.toString().split("").map(e=>{const a=parseInt(e,10);return isNaN(a)?e:P[a]}).join("")}function M(t){if(!t)return"";const e=t.split("-");if(e.length!==3)return"";const a=parseInt(e[0],10),s=parseInt(e[1],10)-1,n=parseInt(e[2],10),o=L(n),r=A[s],m=L(a);return`${o} ${r}, ${m}`}let p=0,c="",T="",w=!1,y=null;const G=5,l=document.getElementById("creator-name"),S=document.getElementById("style-selector");document.getElementById("placeholder-form");const f=document.getElementById("btn-generate"),g=document.getElementById("prompt-output-box"),B=document.getElementById("btn-copy-prompt"),N=document.getElementById("btn-gemini"),D=document.getElementById("btn-copy-main");document.getElementById("btn-download");document.getElementById("preview-placeholder-state");document.getElementById("preview-loading-state");document.getElementById("preview-error-state");document.getElementById("preview-result-state");document.getElementById("preview-image");document.getElementById("error-message");const j=document.getElementById("btn-retry-preview"),E=document.getElementById("history-container"),_=document.getElementById("btn-clear-history");document.addEventListener("DOMContentLoaded",()=>{v(),H(),J(),V(),l.addEventListener("input",d),f.addEventListener("click",I),B.addEventListener("click",()=>C(c,"પ્રોમ્પ્ટ કોપી થઈ ગયો છે!")),N.addEventListener("click",R),D.addEventListener("click",()=>C(c,"પ્રોમ્પ્ટ કોપી થઈ ગયો છે!")),_.addEventListener("click",q),j.addEventListener("click",I);const t=document.getElementById("btn-calendar"),e=document.getElementById("date-picker-helper"),a=document.getElementById("input-date");t&&e&&a&&(t.addEventListener("click",()=>{e.showPicker()}),e.addEventListener("change",s=>{const n=M(s.target.value);n&&(a.value=n,u(),d(),a.classList.add("input-filled"),setTimeout(()=>a.classList.remove("input-filled"),500))}))});function v(){S.innerHTML="",b.forEach((t,e)=>{const a=e===p,s=a?"border-orange-500 bg-orange-950/20 text-orange-400 glow-saffron":"border-slate-800 hover:border-slate-700 bg-slate-950/60 text-slate-300",n=document.createElement("button");n.className=`flex items-center gap-3 p-3 rounded-xl border text-left transition-all hover:-translate-y-0.5 cursor-pointer ${s}`,n.setAttribute("data-template-id",t.id),n.innerHTML=`
    ...
    `,n.addEventListener("click",()=>{p=t.id,v(),u(),d()}),S.appendChild(n)})}function H(){h.forEach(t=>{const e=document.getElementById(`input-${t.key}`),a=document.getElementById(`suggestions-${t.key}`);if(e&&(e.value||(t.key==="mandal"&&(e.value="અક્ષરધામ"),t.key==="date"&&(e.value="૩૧ મે, ૨૦૨૬"),t.key==="day"&&(e.value="રવિવાર"),t.key==="time"&&(e.value="સાંજે ૪:૩૦ થી ૬:૦૦"),t.key==="venue"&&(e.value="સ્વામિનારાયણ મંદિર, વાડાજ"),t.key==="attr1"&&(e.value="રસપ્રદ રમત ગમત"),t.key==="attr2"&&(e.value=""),t.key==="attr3"&&(e.value="")),e.addEventListener("input",()=>{u(),d()}),e.addEventListener("change",()=>{u(),d()}),a)){a.innerHTML="";const s=document.createElement("span");s.innerText="ટ્રાય: ",s.className="text-[9px] text-slate-500 font-bold self-center mr-1 flex-shrink-0",a.appendChild(s),t.suggestions.forEach(n=>{const o=document.createElement("span");o.innerText=n,o.className="bg-slate-950/80 border border-slate-850 hover:border-slate-700 text-[10px] text-slate-400 px-2 py-0.5 rounded cursor-pointer transition-all hover:bg-slate-900 flex-shrink-0",o.addEventListener("click",()=>{e.value=n,u(),d(),e.classList.add("input-filled"),setTimeout(()=>e.classList.remove("input-filled"),500)}),a.appendChild(o)})}}),u()}function u(){let e=b[p].templateText,a=!0;h.forEach(s=>{const n=document.getElementById(`input-${s.key}`),o=n?n.value.trim():"",r=["mandal","date","day","time","venue"].includes(s.key);o?e=e.replaceAll(`[${s.key}]`,o):(r&&(a=!1),e=e.replaceAll(`[${s.key}]`,""))}),a&&l.value.trim().length>=3?(c=e,g.innerText=e,g.classList.remove("text-slate-600"),g.classList.add("text-slate-300")):(c="",g.innerText="ડાબી બાજુ તમારું નામ અને વિગતો ભરો એટલે પ્રોમ્પ્ટ અહીં આપોઆપ જનરેટ થશે!",g.classList.remove("text-slate-300"),g.classList.add("text-slate-600"))}function d(){const t=l.value.trim(),e=t.replace(/[^a-zA-Z\s]/g,"");t!==e&&(l.value=e,i("નામમાં માત્ર અક્ષરો અને સ્પેસ જ આવી શકે!","error"));let a=!0;e.length<3&&(a=!1),h.forEach(o=>{const r=document.getElementById(`input-${o.key}`),m=r?r.value.trim():"";["mandal","date","day","time","venue"].includes(o.key)&&m.length<2&&(a=!1);const $=m.toLowerCase();k.some(O=>$.includes(O))?(a=!1,r&&(r.style.borderColor="#ef4444"),i("મહેરબાની કરી યોગ્ય શબ્દો લખો. સ્પેમ માન્ય નથી!","error")):r&&(r.style.borderColor="")});const s=e.toLowerCase();k.some(o=>s.includes(o))?(a=!1,l.style.borderColor="#ef4444",i("અમાન્ય નામ!","error")):l.style.borderColor="";const n=y!==null;return f.disabled=!a||n,B.disabled=!a,N.disabled=!a,D.disabled=!a,a}function I(){if(!d()||w)return;w=!0;const t=Math.floor(Math.random()*999999);if(T=`https://image.pollinations.ai/prompt/${encodeURIComponent(c)}?width=800&height=800&nologo=true&seed=${t}`,w=!1,F(),i("પ્રોમ્પ્ટ સફળતાપૂર્વક તૈયાર થઈ ગયો છે! ✨","success"),window.innerWidth<1024){const a=document.getElementById("output-section");a&&a.scrollIntoView({behavior:"smooth",block:"start"})}l.value.trim(),b[p].title,U()}function U(){let t=G;f.disabled=!0,y=setInterval(()=>{t--,f.querySelector(".btn-text").innerText=`થોડીવાર થોભો (${t}s)`,t<=0&&(clearInterval(y),y=null,f.querySelector(".btn-text").innerText="પ્રોમ્પ્ટ જનરેટ અને સેવ કરો",d())},1e3)}function R(){c&&navigator.clipboard.writeText(c).then(()=>{i("પ્રોમ્પ્ટ કોપી થઈ ગયો છે! જેમિની ઓપન થઈ રહ્યું છે...","success"),setTimeout(()=>{window.open("https://gemini.google.com/app","_blank")},800)}).catch(t=>{console.error("Failed to copy: ",t),i("કોપી કરવામાં મુશ્કેલી પડી.","error")})}function C(t,e){navigator.clipboard.writeText(t).then(()=>{i(e,"success")}).catch(()=>{i("ક્લિપબોર્ડ એક્સેસ રિજેક્ટ થયો.","error")})}function V(){const t=new URLSearchParams(window.location.search),e=t.get("creator"),a=t.get("template"),s=t.get("inputs");if(e&&a!==null&&s)try{const n=JSON.parse(s);l.value=e,p=parseInt(a,10),v(),Object.keys(n).forEach(r=>{const m=document.getElementById(`input-${r}`);m&&(m.value=n[r])}),u();const o=d();i(`${e} દ્વારા મોકલાયેલો પ્રોમ્પ્ટ લોડ થઈ રહ્યો છે...`,"info"),o&&setTimeout(I,600)}catch(n){console.error("Error parsing shared link inputs",n)}}function i(t,e="success"){const a=document.getElementById("toast-container"),s=document.createElement("div");s.className="flex items-center gap-3 bg-slate-900 border rounded-xl px-5 py-3 shadow-2xl transition-all duration-300 pointer-events-auto transform translate-y-0 opacity-100";let n="bg-orange-500/10 text-orange-400",o="border-orange-500/50",r=`
  ...
  `,a.appendChild(s),setTimeout(()=>{s.classList.remove("translate-y-0","opacity-100"),s.classList.add("translate-y-12","opacity-0"),s.addEventListener("transitionend",()=>{s.remove()})},3500)}function F(){const t=l.value.trim(),e={};h.forEach(o=>{e[o.key]=document.getElementById(`input-${o.key}`).value.trim()});const a={id:Date.now(),creator:t,templateId:p,prompt:c,imageUrl:T,inputs:e,timeString:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})};let s=JSON.parse(localStorage.getItem("baps_mandal_history"))||[];s.length>0&&s[0].prompt===c||(s.unshift(a),s.length>10&&s.pop(),localStorage.setItem("baps_mandal_history",JSON.stringify(s)),x())}function J(){x()}function x(){const t=JSON.parse(localStorage.getItem("baps_mandal_history"))||[];if(E.innerHTML="",t.length===0){E.innerHTML=`
    ...
    `;return}t.forEach(e=>{const a=b[e.templateId],s=document.createElement("div");s.className="flex items-center justify-between gap-3 p-3 bg-slate-950/60 border border-slate-900 rounded-xl hover:border-slate-800 transition-all",s.innerHTML=`
    ...
    `,s.querySelector(".btn-use").addEventListener("click",()=>{l.value=e.creator,p=e.templateId,v(),Object.keys(e.inputs).forEach(n=>{const o=document.getElementById(`input-${n}`);o&&(o.value=e.inputs[n])}),u(),d(),i("પ્રોમ્પ્ટ લોડ થઈ ગયો છે!","info")}),s.querySelector(".btn-delete").addEventListener("click",()=>{z(e.id)}),E.appendChild(s)})}function z(t){let e=JSON.parse(localStorage.getItem("baps_mandal_history"))||[];e=e.filter(a=>a.id!==t),localStorage.setItem("baps_mandal_history",JSON.stringify(e)),x(),i("યાદીમાંથી કાઢી નાખવામાં આવ્યું.","info")}function q(){confirm("શું તમે આ ઇતિહાસ કાઢી નાખવા માંગો છો?")&&(localStorage.removeItem("baps_mandal_history"),x(),i("ઇતિહાસ સાફ કરવામાં આવ્યો છે!","info"))}
